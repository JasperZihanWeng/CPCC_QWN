#-------------------------------------------------------------
# Generated Example Tcl script for IP 'clock_test' (xilinx.com:ip:gtwizard:3.6)
#-------------------------------------------------------------

# Set up project params
set_param tcl.statsThreshold 360
# Declare source IP directory
set srcIpDir "c:/Users/Kumar Lab/Desktop/Shannon/clock_test_ex/clock_test_ex.gen/sources_1/ip/clock_test"

# Declare xci file location
set srcXciDir "c:/Users/Kumar Lab/Desktop/Shannon/clock_test_ex/clock_test_ex.srcs/sources_1/ip/clock_test"

# Create project
puts "INFO: \[open_example_project\] Creating new example project..."
create_project -name clock_test_ex -force
...
import_ip -files [list [file join $srcIpDir ../../../../clock_test_ex.srcs/sources_1/ip/clock_test/clock_test.xci]] -name clock_test
if { $returnCode == 0 } { 
  reset_target {open_example} [get_ips clock_test]
  ...
  generate_target [_filter_supported_targets {instantiation_template synthesis simulation implementation shared_logic} [get_ips clock_test]] [get_ips clock_test]
} 
...
if { $returnCode == 0 } { 
  ...
  [list [file join $srcIpDir clock_test/example_design/support/clock_test_common_reset.v]] \
  [list [file join $srcIpDir clock_test/example_design/support/clock_test_clock_module.v]] \
  [list [file join $srcIpDir clock_test/example_design/support/clock_test_common.v]] \
  [list [file join $srcIpDir clock_test/example_design/support/clock_test_gt_usrclk_source.v]] \
  [list [file join $srcIpDir clock_test/example_design/support/clock_test_support.v]] \
  [list [file join $srcIpDir clock_test/example_design/clock_test_exdes.v]] \
  [list [file join $srcIpDir clock_test/example_design/clock_test_gt_frame_check.v]] \
  [list [file join $srcIpDir clock_test/example_design/clock_test_gt_frame_gen.v]]
} 
...
if { $returnCode == 0 } { 
  ...
  [list [file join $srcIpDir clock_test/example_design/gt_rom_init_rx.dat]] \
  [list [file join $srcIpDir clock_test/example_design/gt_rom_init_tx.dat]]
set_property USED_IN_SIMULATION false [get_files [list [file join $srcIpDir clock_test/example_design/gt_rom_init_rx.dat]]]
set_property USED_IN_SIMULATION false [get_files [list [file join $srcIpDir clock_test/example_design/gt_rom_init_tx.dat]]]
} 
...
if { $returnCode == 0 } { 
  ...
  [list [file join $srcIpDir clock_test/example_design/clock_test_exdes.xdc]]
...
if { $returnCode == 0 } { 
  ...
  [list [file join $srcIpDir clock_test/simulation/clock_test_tb.v]]
set_property USED_IN_SYNTHESIS false [get_files [list [file join $srcIpDir clock_test/simulation/clock_test_tb.v]]]
} 
...
if { $returnCode == 0 } { 
  ...
  [list [file join $srcIpDir clock_test/simulation/functional/gt_rom_init_rx.dat]] \
  [list [file join $srcIpDir clock_test/simulation/functional/gt_rom_init_tx.dat]]
set_property USED_IN_SYNTHESIS false [get_files [list [file join $srcIpDir clock_test/simulation/functional/gt_rom_init_rx.dat]]]
set_property USED_IN_SYNTHESIS false [get_files [list [file join $srcIpDir clock_test/simulation/functional/gt_rom_init_tx.dat]]]
} 
...
if { $returnCode == 0 } { 
  ...
  puts "INFO: \[open_example_project\] Sourcing extension script: clock_test/tcl/xci.tcl"
  if {[catch {source [file join $srcIpDir clock_test/tcl/xci.tcl]} errMsg]} {
    puts "ERROR: \[open_example_project\] Open Example Project failed: Error encountered while sourcing custom IP example design script: clock_test/tcl/xci.tcl"
    puts "$errMsg"
    error "ERROR: see log file for details."
    incr returnCode
  }
