...
HD_PWD='C:/Users/Kumar Lab/Desktop/Shannon/clock_test_ex/clock_test_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_test_exdes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clock_test_exdes.tcl -notrace
