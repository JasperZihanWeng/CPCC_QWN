...
HD_PWD='C:/Users/Kumar Lab/Desktop/Shannon/clock_test_ex/clock_test_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_test_exdes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_test_exdes.tcl
